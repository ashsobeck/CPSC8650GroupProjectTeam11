...
def main():
    ...
    train = model.fit(train_dataset, 
              ...
              shuffle=True,
              callbacks=[
                  keras.callbacks.ModelCheckpoint(filepath='./team11_model_save_v3', 
                                                  monitor="val_loss",
                                                  mode="max",
                                                  save_freq='epoch',
                                                  save_best_only=True)  
    ...
    model.load_weights('./team11_model_save_v3')
